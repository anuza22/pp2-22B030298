...
car = pygame.image.load('IMGandMUS/Player.png')
road = pygame.image.load('IMGandMUS/road.png')
coin = pygame.image.load('IMGandMUS/m_coin.jpg')
inc = pygame.image.load('IMGandMUS/Enemy.png')

point_sound = pygame.mixer.Sound('IMGandMUS/cha-ching-7053.mp3')
